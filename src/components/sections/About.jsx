...
export default function About() {
  return (
    <section
      id="about"
      className="relative w-full min-h-screen bg-[#EDE6DA] text-[#0C0C0E] border-t border-b border-black/[0.08] select-none flex flex-col justify-between p-6 sm:p-10 lg:p-14 overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none z-0">
        <img
          ...
          className="w-full h-full object-cover object-[78%_25%] sm:object-[72%_20%] lg:object-[68%_15%]"
        />
        {/* Subtle tone equalizer */}
        <div className="absolute inset-0 bg-[#EDE6DA]/15 mix-blend-multiply pointer-events-none" />
      </div>

      {/* Dynamic Cream Overlay spanning full-width */}
      <div
        ...
        style={{
          background: `
            linear-gradient(to right, 
              ...
              rgba(237, 230, 218, 0.96) 42%, 
              rgba(237, 230, 218, 0.45) 58%, 
              rgba(237, 230, 218, 0.0) 72%, 
              rgba(237, 230, 218, 0.0) 100%
            ),
            linear-gradient(to top, 
              rgba(237, 230, 218, 0.96) 0%, 
              rgba(237, 230, 218, 0.9) 18%, 
              rgba(237, 230, 218, 0.0) 38%
            )
          `
        }}
      />
      ...
      <div className="absolute top-6 left-6 sm:top-8 sm:left-8 text-2xl sm:text-3xl text-[#0C0C0E] select-none four-star z-20">
        ✦
      </div>
      <div className="absolute top-6 right-6 sm:top-8 sm:right-8 text-2xl sm:text-3xl text-[#0C0C0E] select-none four-star z-20">
        ✦
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-2">
        ...
        {/* Top Right: Location Badge & Quote matching Reference */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto my-auto py-4 sm:py-6">
        ...
        <div className="max-w-2xl pl-6 sm:pl-8">
          ...
          {/* SEE-THROUGH TYPOGRAPHY: NITTO JOSHI.
              Using background-clip: text pointing to the single background image */}
          <h2
            className="text-6xl sm:text-7xl md:text-8xl xl:text-9xl font-black tracking-tight leading-[0.88] mb-5 font-display select-none uppercase"
            style={{
          ...
          <div className="mb-5 space-y-1 text-xs sm:text-sm font-sans font-bold tracking-wider text-[#0C0C0E] uppercase">
          ...
          <div className="space-y-3 text-xs sm:text-sm leading-relaxed text-[#0C0C0E] font-sans max-w-xl">
            <p>
